...
%>
      <!-- 왼쪽 사이드 바 -->
   <div id="leftSide" style="width: 10%; height: 100%; top:0px; left: 0px; position: fixed;">                                    
         ...
         <div id="basketBtn">
	         <button type="button" class="btn btn-default btn-lg basketBtn" style="border: none; outline: none;">
