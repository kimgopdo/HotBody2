			...
			<form name="memberForm" method="post">
			      ...
			      <td style="padding: 0 0 15px 15px;">
			        <p style="margin-top: 1px; margin-bottom: 5px;">
			            <input type="password" name="userPwdCheck" maxlength="15"
			                       style="width: 10%;" placeholder="패스워드 확인">
			        </p>
			      ...
			      <td style="padding: 0 0 15px 15px;">
			        <p style="margin-top: 1px; margin-bottom: 5px;">
			            <input type="text" name="birth" value="${dto.birth}" maxlength="10" 
			                       style="width: 15%;" placeholder="생년월일">
			        </p>
			  ...
			  <tr>
			      ...
			      <td width="100" style="padding: 0 0 15px 15px;">
			            ...
			            <input type="text" name="email1" value="${dto.email1}" size="13" maxlength="20" style="width: 15%;">
			            @<input type="text" name="email2" value="${dto.email2}" size="13" maxlength="30" readonly="readonly" style="width: 15%;">
			      </td>
			  </tr>
			  <tr>
			      <td width="100" valign="top" style="text-align: right; padding-top: 5px;">
