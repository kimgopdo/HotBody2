...
<table style="width: 700px; margin: 20px auto 0; border-collapse: collapse; border-spacing: 0">
	...
	<tr align="center" height="40"
		...
		<td align="center" style="padding-left: 5px">
			<a href="${articleUrl}&qna2Code=${dto.qna2Code}" style="text-decoration: none; color: black;">${dto.subject}</a>
		</td>
	...
	<tr>
		...
		<form name="searchList" method="post" action="<%=cp%>/qna2/list">
			...
			<button type="button" class="btn-list" onclick="javascript:location.href='<%=cp%>/qna2/created'" style="float: right; width: 80px;">글올리기</button>
			<button type="button" class="btn-list" onclick="javascript:location.href='<%=cp%>/qna2/list';" style="float: right; width: 80px; margin-right: 10px;">새로고침</button>
		</form>
		</td>
	</tr>
</table>
