...
<tr height="40">
	<td width="100" valign="top" align="center" style="font-weight: bold; color: #666666;">
		내&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;용
	</td>
	<td>
		<textarea style="width: 98%;" rows=20; name="content" id="content">${dto.content}</textarea>
	</td>
</tr>
<tr height="10px;"></tr>
...
<c:if test="${mode=='update'}">
	...
	<input type="hidden" name="infoNum" value="${dto.infoNum}">
