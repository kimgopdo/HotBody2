...
<body style="overflow: hidden; height: 1100px;">
	...
	<div
		style="font-size: 40px; width: 700px; margin: 20px auto 0; font-weight: bold; color: #666666;">모꼬지
		개설하기</div>
	<div
	...
	<form action="<%=cp%>/mocojee/${mode}" method="post" name="boardForm"
		...
		<table
			...
			<tr height="40">
				<td width="100">모꼬지명</td>
				<td><input type="text" name="moName"
					style="width: 98%; height: 35px;" value="${dto.moName}"></td>
			</tr>


			<tr height="40">
				<td width="100" valign="top">운영진 한마디</td>
				<td><input type="text" name="soGae"
					style="width: 98%; height: 35px;" value="${dto.soGae}"
					placeholder="회원들에게 간단한 한마디 부탁드려요!"></td>
			</tr>

			<tr height="10px;"></tr>

			<tr height="40px;">
				<td width="100" valign="top">간단 소개</td>
				<td><textarea style="width: 98%;" rows=6; name="moIntro"
						placeholder="모임을 홍보할 수 있는 짧고 굵은 소개 부탁드려요!">${dto.moIntro}</textarea>
				</td>
			</tr>
